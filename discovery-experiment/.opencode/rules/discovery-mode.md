# Discovery Mode — Native Agent Instructions

Activate this behavior when the user starts a request with `/discover`. Do NOT run any local Node CLI commands or Groq APIs. Execute the reasoning protocol natively using your own active model.

## RULE: When the user writes `/discover <task>`, run ALL FOUR phases below.
